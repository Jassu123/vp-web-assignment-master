  ...
  movies.forEach(function(movie) {
    components.push(
      <div className="all">
        ...
        <span>
          <a className="movie-watched" href="#" onClick={function() { addWatchedMovie(movie.title, movie.comment, movie.movieUrl) }}>
            {movie.title}
          </a>
        </span>
        <br />
...
function App(props) {
  return (
    <div className="App">
      ...
      <b>movieUrl URL:<br /><input type="text" onChange={function(e) { movieUrl = e.target.value; }} /></b><br />
      <b>COMMENT:<br /><input type="text" onChange={function(e) { comment = e.target.value; }} /></b><br />
      <input type="button" onClick={function(e) { add(title, movieUrl, comment); }} value="ADD MOVIE" />
